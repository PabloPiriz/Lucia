...
public class CargadorRecursos {
	...
	public static BufferedImage cargarImagenCompatibleOpaca(final String ruta) {
		...
		try {
			...
			Log.addMensaje("Imagen cargada: "+ruta);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static BufferedImage cargarImagenCompatible(final String ruta, final int transparencia) {
		Image imagen = null;
	...
	public static Mapa cargarMapa(final String ruta){
		String contenido = "";
